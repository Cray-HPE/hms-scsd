...
#         /opt/cray/tests/ncn-destructive/hms/hms-scsd on the NCN.
#
#     BUGS/LIMITATIONS
#       None
#
...
PYTEST_INI_PATH="/opt/cray/tests/ncn-destructive/hms/hms-scsd/pytest.ini"
...
COMMON_FILE_PATH="/opt/cray/tests/ncn-destructive/hms/hms-scsd/common.yaml"
SCSD_TEST_DIR="/opt/cray/tests/ncn-destructive/hms/hms-scsd"
